						...
						<div class="mx-header">
							<div class="mx-header-height">
								<div class="mx-header-box">
									<!-- 菜单相关内容 -->
									<input type="checkbox" id="menu-opener-id" class="mx-menu-opener" style="display: none;">
									<!-- 关联按钮 -->
									...
									<div class="mx-menu">
										<div class="mx-first-menu db">
											<!-- 一个li -->
											<div class="mx-first-menu-li now">
...
<style scoped="scoped">
	...
	.mx-header-height {
		...
		left: 0;
		box-shadow: 0 2px 6px rgba(76, 86, 114, .12);
		z-index: 1000;
	}
